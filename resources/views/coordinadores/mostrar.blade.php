...
@section('content')
    ...
    <div class="modal fade" id="abcd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form class="row g-3" method="post" action="{{ route('guardar.coordinador') }}">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Crear Coordinador.</h1>
            ...
            <table class="table table-hover">
                ...
                <tbody id="the_table_body">
                    @foreach ($coordinadores as $coordinador)
                        <tr>
                            <td>{{ $coordinador->Entidad->nombre }}</td>
                            ...
                            <td><button style="width: 100%" type="button" class="btn btn-primary"
                                    data-bs-toggle="modal" data-bs-target="#show{{ $coordinador->id }}">
                            ...
                            <td><button style="width: 100%" type="button" class="btn btn-warning"
                                    data-bs-toggle="modal" data-bs-target="#efg{{ $coordinador->id }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            ...
                            <td><button style="width: 100%" type="button" class="btn btn-danger" data-bs-toggle="modal"
                                    data-bs-target="#abcd{{ $coordinador->id }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        <!-- Modal Eliminar -->
                        <div class="modal fade" id="abcd{{ $coordinador->id }}" tabindex="-1"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Eliminar Coordinador.</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <h5>Está seguro que quieres eliminar el Coordinador? </h5>
                                                <strong>{{ $coordinador->nombre }}</strong> ?
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button style="width:100%" class="btn btn-danger" type="submit"
                                            id="eliminarArticulo"
                                            onclick="eliminarCoordinador({{ $coordinador->id }})">Eliminar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Modal show -->
                        <div class="modal fade" id="show{{ $coordinador->id }}" tabindex="-1"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="row">
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item">
                                                    <h3>Entidad a la que pertene: {{ $entidad->nombre }}</h3>
                                                </li>
                                                <li class="list-group-item">
                                                    <h3>Nombre: {{ $coordinador->nombre }}</h3>
                                                </li>
                                                <li class="list-group-item">
                                                    <h3>Apellidos: {{ $coordinador->apellidos }}</h3>
                                                </li>
                                                <li class="list-group-item">
